...
export interface ApprovalAttestationJobOptions {
  enabled: boolean;
...
export class ApprovalAttestationJobService {
  private options: ApprovalAttestationJobOptions;
  private attestationService: ApprovalAttestationService;
  ...
  constructor(
    options: ApprovalAttestationJobOptions,
    attestationService: ApprovalAttestationService,
    ledger: AuditLedger,
  ) {
  ...
  async runNow(): Promise<void> {
    ...
    try {
      ...
      const snapshotPath = path.join(
        ...
        `approval-attestation-${stamp}.json`,
      );
      ...
      this.ledger.logAndSignAction("APPROVAL_ATTESTATION_PERIODIC_EXPORTED", {
      ...
      this.ledger.logAndSignAction("SYSTEM_ERROR", {
        module: "approval-attestation-job",
        stage: "run",
  ...
  private pruneSnapshots(): void {
    ...
    this.ledger.logAndSignAction("APPROVAL_ATTESTATION_SNAPSHOTS_PRUNED", {
